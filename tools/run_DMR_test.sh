...
../build/icgen-ug ../test_problems/double_Mach_reflection/params_DMR_n160.txt silo redirect=iclog
../build/pion-ug DMRm10t60_n160_0000.00000000.silo outfile=DMR_new_n160 redirect=pionlog

REF_FILE=DMRm10t60_n160_0000.00000365.silo
NEW_FILE=`ls DMR_new_n160_0000.*.silo | tail -n1`
../build/silocompare . $NEW_FILE data $REF_FILE 0 cmp 2 > tmp.txt
