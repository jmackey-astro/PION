...
int main(int argc, char **argv)
{
  ...
  if (argc<6) {
    cout << "Use as follows:\n";
    cout << "executable-filename: <executable-filename> <input-path> <input-silo-file-base> <angle>\n";
    cout << "\t\t <output-file> <op-file-type>";
    cout << " <skip>\n";
    cout <<"******************************************\n";
    cout <<"input path:   path to input files.\n";
    cout <<"input file:   base filename of sequence of files.\n";
    cout <<"angle:        Angle with respect to symmetry-axis for projection (degrees, float)\n";
