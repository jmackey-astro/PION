 ...
 * 
 * Compile with:\n
 * g++ -Wall -g -DSERIAL plot_radius.cc ../../testing/global.cc ../../testing/uniformGrid.cc ../../testing/dataio.cc -lreadline -lcfitsio
 * 
 * Run with (example):\n
...
int main(int argc, char **argv)
{
  ...
  outf << "# Columns are [time, I-front position, err, posn from Nions, Nions, Nphotons], and should be in cgs units (s,cm).\n\n";
  ...
  do {
     ...
     outf <<"\t"<<nions<<"\t"<<SimPM.simtime*RSP.strength[0]<<endl;
