...
# 2011.07.12 JM: Adapted for dynamic model with 1/r density profile.

test_dir=/users/jmackey/active/projects/uniform_grid_code/trunk/test/problems/RT_Erg_NoDyn
exe_dir=/users/jmackey/active/projects/uniform_grid_code/trunk/test/problems/RT_Erg_NoDyn
...
fbase0=rtt_Sph1D_ERG_n128_nh3_slope1
