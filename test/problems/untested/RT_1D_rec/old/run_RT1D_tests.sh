...
# current dir
test_dir=/users/jmackey/active/projects/uniform_grid_code/trunk/test/problems/RT_1D_rec
# where exes are located
exe_dir=/users/jmackey/active/projects/uniform_grid_code/trunk/test/problems/RT_1D_norec
