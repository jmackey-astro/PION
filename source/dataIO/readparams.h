...
class ReadParams 
{
 ...
 private :
   ...
   //static const int arraylength=150;   /**< \brief size of array for parameters (modify if needed).*/
   //std::string params[arraylength][2]; /**< \brief array to store parameters in.*/
};
