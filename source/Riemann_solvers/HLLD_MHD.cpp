...
)
{
  ...
  HD_ULs[eqERG] = (sl_vl * HD_UL[eqERG] - tp_l * Pl[eqVX] + tp_s * HD_lambda[2]
                   + BX * (temp_l1 - temp_l2))
                  / sl_sm;  // e* (m05 eq 48)
  HD_URs[eqERG] = (sr_vr * HD_UR[eqERG] - tp_r * Pr[eqVX] + tp_s * HD_lambda[2]
                   + BX * (temp_r1 - temp_r2))
                  / sr_sm;
  ...
  if (BX == 0) {
    ...
    HD_ULss[eqERG] =
        HD_ULs[eqERG] - temp_l1 * (temp_l2 - temp) * sgn;  // E** (m05 eq 63)
