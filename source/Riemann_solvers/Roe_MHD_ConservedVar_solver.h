...
private:
  ...
  ///
  /// Get the Roe averages differences for the primitive and conserved
  ...
  /// H-correction.
  ///
  int Roe_get_eigenvalues(const pion_flt  ///< H-correction eta-max.
  );
  ...
  double Roe_V,                ///< mean state velocity magnitude
      ...
      Roe_cs,                  ///< slow speed
      Roe_ca;                  ///< Alfven speed.
  double Roe_alphas,           ///< Roe-Balsara slow norm.
