                      ...
                      virtual public findroot
{
 public:
  ...
  ///
  riemann_Euler(const int,      ///< Length of State Vectors, nvar
  ...
  ///  
  int JMs_riemann_solve(const double *, ///< Left Primitive var. state vector.
 ...
 private:
   ...
   double *rs_left;  ///< Local copy of the left state.
   double *rs_right; ///< Local copy of the right state.
   double *rs_pstar; ///< Local copy of result state.
   double *rs_meanp; ///< The average state.
...
#ifdef RSTESTING
   double *linearpstar; ///< (TESTING) Testing variable, for the result state from the linear solver.
