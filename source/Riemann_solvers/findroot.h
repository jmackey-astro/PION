...
/// It must also take pion_flt *ans as an argument, and any data parameters it needs,
...
class findroot
{
  public:
   ...
   /// 
   virtual int FR_find_root(pion_flt *, ///< pointer to result 
   ...
   /// 
   int solve_test(pion_flt *,    ///< pointer to result.
  ...
  /// \brief The general (private) solver function to get the roots of your equation
   ...
   /// 
   int solve_pm(pion_flt, ///< Initial bracketing value guess x1 
  ...
  private:
   pion_flt errtol; ///<  The error tolerance of the solution, set to 1e-8 by default. 
   ///
   ...
   /// \retval 1 Failure.
   /// 
   int bracket_root_pos(pion_flt *, ///< The lower bracketing value x1  
   ...
   /// \retval 1 Failure.
   /// 
   int bracket_root_pm(pion_flt *, ///< The lower bracketing value x1  
		       pion_flt *  ///< The upper bracketing value x2 
		       );
   ...
   /// \retval 1 fail.
   /// 
   int find_root_bisection(pion_flt *, ///< lower bound x1 
   ...
   /// \retval 1 fail.
   /// 
   int find_root_zbrent(pion_flt x1,  ///< lower bound x1 
