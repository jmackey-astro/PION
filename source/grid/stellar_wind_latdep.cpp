...

{
  ...
  //cout <<"stellar_wind_latdep::c_xi    = "<<c_xi<<"\n";
  stellar_wind_latdep::c_beta  = -1.0;
  
  // Number of points in theta, omega and Teff vectors
  stellar_wind_latdep::npts_theta = 25;
  stellar_wind_latdep::npts_omega = 25;
  stellar_wind_latdep::npts_Teff = 22;
...
double stellar_wind_latdep::pow_fast(
	double a,
	double b
	)
{
...
double stellar_wind_latdep::integrand(
...
// Phi' function
double stellar_wind_latdep::fn_phi(
	double omega, // omega (v_rot/v_crit)
	double theta, // Co-latitude angle (radians)
	double Teff // Teff (K)
	)
...
// Alpha function
double stellar_wind_latdep::fn_alpha(
	double omega, // Omega (v_rot/v_crit)
	double theta, // Co-latitude angle (radians)
	double Teff // Teff (K)
	)
...
// Delta function
double stellar_wind_latdep::fn_delta(
	double omega, // Omega (v_rot/v_crit)
	double Teff // Teff (K)
	)
{
...
double stellar_wind_latdep::fn_density(
	double omega, // Omega (v_rot/v_crit)
	double v_inf, // terminal velocity at pole (cm/s)
...
double stellar_wind_latdep::fn_density_interp(
	double omega, // Omega (v_rot/v_crit)
	double v_inf, // terminal velocity at pole (cm/s)
	double mdot, // Mass loss rate (g/s)
	double radius, // Radius (cm)
