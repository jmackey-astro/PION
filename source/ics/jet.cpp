...
)
{
  ...
  str  = rp->find_parameter(seek);
  if (str != "")
    IC_jet::ambient[RO] = atof(str.c_str());
  else
    IC_jet::ambient[RO] = -1.0e99;
  ...
  str  = rp->find_parameter(seek);
  if (str != "")
    IC_jet::ambient[PG] = atof(str.c_str());
  else
    IC_jet::ambient[PG] = -1.0e99;
  ...
  str  = rp->find_parameter(seek);
  if (str != "")
    IC_jet::ambient[VX] = atof(str.c_str());
  else
    IC_jet::ambient[VX] = -1.0e99;
  ...
  str  = rp->find_parameter(seek);
  if (str != "")
    IC_jet::ambient[VY] = atof(str.c_str());
  else
    IC_jet::ambient[VY] = -1.0e99;
  ...
  str  = rp->find_parameter(seek);
  if (str != "")
    IC_jet::ambient[VZ] = atof(str.c_str());
  else
    IC_jet::ambient[VZ] = -1.0e99;
  ...
  if (eqns == 2) {  // mhd sim
    ...
    str  = rp->find_parameter(seek);
    if (str != "")
      IC_jet::ambient[BX] = atof(str.c_str());
    else
      IC_jet::ambient[BX] = -1.0e99;
    ...
    str  = rp->find_parameter(seek);
    if (str != "")
      IC_jet::ambient[BY] = atof(str.c_str());
    else
      IC_jet::ambient[BY] = -1.0e99;
    ...
    str  = rp->find_parameter(seek);
    if (str != "")
      IC_jet::ambient[BZ] = atof(str.c_str());
    else
      IC_jet::ambient[BZ] = -1.0e99;
  ...
  for (int t = 0; t < SimPM->ntracer; t++) {
    ...
    str  = rp->find_parameter(seek);
    if (str != "")
      IC_jet::ambient[t + SimPM->ftr] = atof(str.c_str());
    else
