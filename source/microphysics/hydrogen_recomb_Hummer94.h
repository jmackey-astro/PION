...
class Hummer94_Hrecomb
{
  ...
  ///
  /// Recombination rate from H+ to H0, in cm^{3}/s, according to Hummer (1994)
  /// 
  double Hii_rad_recomb_rate(double ///< electron temperature.
                             );

  ///
  /// Cooling rate due to recombination from H+ to H0, according to Hummer (1994),
  /// in units erg.cm^{3}/s
  ///
  ...
  ///
  /// Cooling rate due to ionised Hydrogen, being the sum of radiative recombination
  /// and free-free (Bremsstrahlung) cooling, beta_B^tot (last column of Table 1 in 
  /// Hummer (1994).
  ///
 ...
 //   *hr_btot2;  ///< array for total energy loss rate.
  ...
  double
    MinSlope_alpha, ///< Logarithmic slope for extrapolating spline fit.
