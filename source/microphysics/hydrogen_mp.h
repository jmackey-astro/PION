...
///
/// Hydrogen chemistry class, bringing together a lot of functions which calculate
/// heating/cooling rates and ionisation/recombination rates for atomic Hydrogen.
///
class Hydrogen_chem : public Hummer94_Hrecomb, public hydrogen_photoion 
{
  ...
  ///
  /// Collisional ionisation cooling rate (calculated as for the ionisation rate, but
  /// assuming that the binding energy is lost from the system in every 
  /// ionisation, assumed to be from the ground state).
  ///
