...
#define MPv10_RELTOL                                                           \
  1.0e-10  ///< relative-error tolerance (actual error can be larger).
...
protected:
  ...
  int ftr;  // lv_y_ion_index_offset; ///< gives the index at which ions first
            // occur in primitive vector, maps to first index of local vector
  ...
  std::vector<int>
      y_ion_index_prim;  ///< index matching y_ion mass fraction in prim vector,
                         ///< analogous to pv_Hp before.
  std::vector<int>
      y_ion_index_local;  ///< index matching y_ion fraction in local vector.
  std::vector<std::vector<double> >
      y_ion_xsections;  ///< index matching photo_ion xsection to ion in local
                        ///< vector
  ...
  std::vector<int> y_ip1_index_tables;  ///< index of the ip1 species in tables.
                                        ///< This follows the order "H0", "H1+",
                                        ///< "He0", "He1+", "He2+" etc.
  std::vector<int> y_ion_index_tables;
  std::vector<int> y_im1_index_tables;  ///< index of the im1 species in tables.
  ...
  /// ===========================================================================
  std::vector<int>
      y_ion_num_elec;  ///< index matching number of electrons corresponding to
                       ///< each y_ion (e.g. C6+ = 6)
  std::vector<double>
  ...
  double dielec_recomb(double, enum species);
  double rad_recomb(double, enum species);
