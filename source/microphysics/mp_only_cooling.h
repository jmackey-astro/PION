  ...
  virtual public Hummer94_Hrecomb
{
  ...
  /// value.  This function does nothing here.
   ...
   /** \brief Given a cell, calculated converged time-averaged rates of 
    ...
    * */
   virtual int Get_MP_Rates(cell *,       ///< current cell.
  ...
  /// capability than the other timescales function.  But for this class, which by
  /// definition has no radiative transfer capability, it doesn't do anything!
  ///
 ...
 private:
  ...
  ///
  /// Calculate the rate of change of internal energy density (result is returned
  /// in units of erg/cm3/s).  This function just goes through a switch/case 
  /// list of functions for the different cooling functions used.
  ///
  double Edot(const double, ///< mass density (g/cm3)
  ...
  ///
  /// A bit more self-consistent: metal cooling due to WSS09-CIE or photoionised
  /// metal lines (from Henney et al 2009) -- we take the max of these two.
  /// Hydrogen cooling from Hummer 1994 recombination+Bremsstrahlung rate.
  /// Heating from 5eV times the Hummer 1994 recombination rate.
  ///
