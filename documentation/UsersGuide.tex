...
You should have \verb|cmake| installed on the computer (needed for the Sundials library).
...
\verb|sudo port install mpich-gcc49 +threads|
\verb|port select --list mpi|
\verb|sudo port select --set mpi mpich-gcc49-fortran|
