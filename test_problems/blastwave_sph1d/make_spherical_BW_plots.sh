...
./plot_sphBW_dens_pres_profile.sh ${data_dir}/BW1D_Profile50kyr_Roe_HCorr \
$file1 $file2 $file3 \
...
./plot_sphBW_dens_pres_profile.sh ${data_dir}/BW1D_Profile50kyr_Roe_FKJ98 \
$file1 $file2 $file3 \
...
./plot_sphBW_dens_pres_profile.sh ${data_dir}/BW1D_Profile50kyr_RPV_FKJ98 \
$file1 $file2 $file3 \
...
./plot_sphBW_dens_pres_profile.sh ${data_dir}/BW1D_Profile50kyr_FVS_FKJ98 \
$file1 $file2 $file3 \
...
./plot_sphBW_dens_pres_profile.sh ${data_dir}/BW1D_Profile50kyr_Hyb_FKJ98 \
$file1 $file2 $file3 \
...
./plot_sphBW_dens_pres_profile.sh ${data_dir}/BW1D_Profile50kyr_aaN256_HRc1Rc2 \
$file1 $file2 $file3 \
...
./plot_sphBW_dens_pres_profile.sh ${data_dir}/BW1D_Profile50kyr_aaN256_HRpFS \
$file1 $file2 $file3 \
...
./plot_sphBW_radius.sh ${data_dir}/BW1D_radius_RCV_FKJ98 \
...
./plot_sphBW_radius.sh ${data_dir}/BW1D_radius_FVS_FKJ98 \
...
./plot_sphBW_radius.sh ${data_dir}/BW1D_radius_Hyb_FKJ98 \
...
./plot_sphBW_radius.sh ${data_dir}/BW1D_radius_RPV_FKJ98 \
