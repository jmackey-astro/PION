...
../../../pion_serial IC_Spitzer1D_n0080.silo 5 1 optype=silo outfile=${data_silo}/S1D_n0080 redirect=log_S1Dn0080  &
../../../pion_serial IC_Spitzer1D_n0080.silo 5 1 optype=text outfile=${data_ascii}/S1D_n0080 redirect=log_junk &
#wait
../../../pion_serial IC_Spitzer1D_n0160.silo 5 1 optype=silo outfile=${data_silo}/S1D_n0160 redirect=log_S1Dn0160 &
../../../pion_serial IC_Spitzer1D_n0160.silo 5 1 optype=text outfile=${data_ascii}/S1D_n0160 redirect=log_junk &
#wait
../../../pion_serial IC_Spitzer1D_n0320.silo 5 1 optype=silo outfile=${data_silo}/S1D_n0320 redirect=log_S1Dn0320 &
../../../pion_serial IC_Spitzer1D_n0320.silo 5 1 optype=text outfile=${data_ascii}/S1D_n0320 redirect=log_junk &
#wait
../../../pion_serial IC_Spitzer1D_n0640.silo 5 1 optype=silo outfile=${data_silo}/S1D_n0640 redirect=log_S1Dn0640 &
../../../pion_serial IC_Spitzer1D_n0640.silo 5 1 optype=text outfile=${data_ascii}/S1D_n0640 redirect=log_junk &
#wait
../../../pion_serial IC_Spitzer1D_n1280.silo 5 1 optype=silo outfile=${data_silo}/S1D_n1280 redirect=log_S1Dn1280 &
